...
from .views import login_view, signup_view, profile_view, dashboard_data_view, devices_view, device_parameters_view, activities_view, reports_view, hourly_report_view, daily_report_view, monthly_report_view, faults_view
