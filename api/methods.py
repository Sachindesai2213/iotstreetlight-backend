...
def meters_data(user_id):
    ...
    for meter in meters:
        meter['parameters'] = list(MetersThreshold.objects.filter(meter_id=meter['id']).values('id', 'meter_id', 'meter__name', 'parameter_name', 'field_name', 'unit', 'min_thr', 'max_thr', 'notify'))
